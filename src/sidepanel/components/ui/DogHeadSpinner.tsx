...
/**
 * Spinner component
 * Uses product logo SVG
 */
export function DogHeadSpinner({
  className = "",
  size = 24,
}: DogHeadSpinnerProps) {
  return (
    ...
    >
      ...
      <svg
        width={size}
        height={size}
        viewBox="-52.978 -64.964 1024 1024"
      ...
      >
        <switch>
          ...
          <g>
            <path
              fill="#fff"
              d="M910.053 738.831c0 94.563-76.659 171.222-171.222 171.222h-567.61C76.658 910.053 0 833.394 0 738.831v-567.61C0 76.658 76.658 0 171.221 0h567.61c94.563 0 171.222 76.658 171.222 171.221z"
            />
            <path
              fill="#b3b3b3"
              d="M488.845 635.875S530.5 740.187 649.187 910.053c4.675-145.165-10.327-214.172-10.327-214.172"
              opacity=".34"
            />
            <path
              fill="#fb651f"
      ...
      >
        ...
        {/* White circle boundary tracing effect - where white meets orange */}
        <path
          fill="none"

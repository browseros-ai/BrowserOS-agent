              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground/80 leading-relaxed">
                    You can interrupt me anytime by typing a new instruction.
                    I'll pause what I'm doing and switch to your new task
                    immediately.
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-3">
            ...
            {Object.entries(AGENT_EXAMPLES).map(([key, agent]) => (
              <div key={key} className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground/80 ml-3.5">
                  {agent.description}
                </p>

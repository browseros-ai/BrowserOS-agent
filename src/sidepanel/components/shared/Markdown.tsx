...
export function MarkdownContent({
  ...
  if (skipMarkdown) {
    return (
      <div className={cn("text-sm", compact && "space-y-1", className)}>
        ...
        options={{
          ...
          overrides: {
            ...
            table: {
              ...
              props: {
                className:
                  "w-full border-collapse border border-border rounded-lg my-4 min-w-full",
              },
            },
            ...
            h1: {
              component: "h1",
              props: { className: "text-2xl font-bold mb-3" },
            },
            h2: {
              component: "h2",
            ...
            h4: {
              component: "h4",
              props: { className: "text-base font-semibold mb-1" },
            },
            h5: {
              component: "h5",
              props: { className: "text-sm font-semibold mb-1" },
            },
            h6: {
              component: "h6",
              props: { className: "text-sm font-semibold mb-1" },
            ...
            th: {
              ...
              props: {
                className:
                  "border border-border bg-muted/80 px-3 py-2 text-left font-medium text-sm text-foreground",
              },
            },
            // Table cells
            td: {

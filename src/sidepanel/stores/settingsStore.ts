    ...
    }),
    {
      ...
      migrate: (persisted: any, version: number) => {
        ...
        if (version === 1 && persisted) {
          ...
          const next = {
            fontSize:
              typeof persisted.fontSize === "number" ? persisted.fontSize : 16,
        ...
        if (version === 2 && persisted) {
          return {
            fontSize:
              typeof persisted.fontSize === "number" ? persisted.fontSize : 16,
            theme:
              persisted.theme === "dark" || persisted.theme === "gray"
                ? persisted.theme
                : "light",
            autoScroll: true,
          } as Settings;
          ...
          return {
            ...
            theme:
              persisted.theme === "dark" || persisted.theme === "gray"
                ...
                : "light",
            autoScroll:
              typeof persisted.autoScroll === "boolean"
          ...
          return {
            ...
            autoScroll:
              typeof persisted.autoScroll === "boolean"
                ...
                : true,
            autoCollapseTools:
              typeof persisted.autoCollapseTools === "boolean"
                ? persisted.autoCollapseTools
                : false,
            chatMode: false,
          } as Settings;
        }

...
import {
  TemplateSchema,
  type Template,
} from "@/newtab/schemas/template.schema";
...
const TEMPLATES: Template[] = z.array(TemplateSchema).parse([
  {
    ...
    notes: ["Be concise; don't use slang.", "Skip ads and suggested follows."],
  },
  {
  ...
  },
  {
    ...
    notes: ["Be concise and factual; no emojis."],
  },
  {
    ...
    notes: ["Keep it brief and actionable."],
  },
  {
  ...
  },
  {
    ...
    notes: ["Avoid NSFW content; skip if unclear."],
  },
  {
    ...
    notes: ["Keep bullets short; no spoilers."],
  },
  {
    id: "hackernews-top",
  ...
  },
  {
    ...
    notes: ["Do not change read status or unsubscribe."],
  },
]);
